...
@ComponentScan(basePackages = "com.cms.dao com.cms.service com.cms.utility")
@PropertySource(value="com/cms/resources/configuration.properties")
public class SpringConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUsername("T562823");
		dataSource.setPassword("T562823");
		return dataSource;
	}
	...
	public LocalSessionFactoryBean getSessionFactory(DataSource dataSource) {
		 ...
		 * sessionFactoryBean
		 */
		sessionFactoryBean.setPackagesToScan("com.cms.entity");
